...
\caption{Comparison of the analytical Duffing prediction, the numerical evaluation on the Duffing sech orbit, and the numerical evaluation on the Bessel orbit.}
\end{figure}
...
\caption{Poincaré sections, bifurcation diagrams, and phase-space trajectories for the reduced Duffing, 12-neuron full circuit, and 6-neuron full circuit.}
\end{figure}
...
\caption{Phase-slipping and pendulum-analogy chaotic regime in the full circuit versus the reduced Duffing model.}
\end{figure}
