...
% ----------------------------------------------------
  ...
  \includegraphics{../figures_melnikov/homoclinic_rhs.png}
  };
  \node at (13, 99) [anchor = north west] {
  \includegraphics{../figures_melnikov/fcrit_omega.png}
  };
  \node at (28, 99)[anchor = north west] {
  \includegraphics{../figures_melnikov/MtF.png}
  };

  \node at(0.5, 100)[anchor = north, font = \bfseries, scale = 3]{A};
  \node at(13.5, 100)[anchor = north, font = \bfseries, scale = 3]{B};
  \node at(28.5, 100)[anchor = north, font = \bfseries, scale = 3]{C};
