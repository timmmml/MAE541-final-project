...
% \node at (10,90) [anchor=base,font=\bfseries,scale=1.5] {A};
  ...
  \includegraphics{../figures_melnikov/duffing_poincare_hhf.png}
  };
  \node at (0, 88) [anchor = north west] {
  \includegraphics{../figures_melnikov/duffing_poincare_traj_hhf.png}
  };

  \node at(0, 100)[anchor = north, font = \bfseries, scale = 3]{A};
  \node at(1, 99.5)[anchor = north, font = \bfseries, scale = 2]{i};
  \node at(1, 88.5)[anchor = north, font = \bfseries, scale = 2]{ii};

  \node at (0, 77) [anchor = north west] {
  \includegraphics{../figures_melnikov/pfl3_12_poincare_hhf.png}
  };
  \node at (0, 66) [anchor = north west] {
  \includegraphics{../figures_melnikov/pfl3_12_poincare_traj_hhf.png}
  };
  \node at(0, 78)[anchor = north, font = \bfseries, scale = 3]{B};
  \node at(1, 77.5)[anchor = north, font = \bfseries, scale = 2]{i};
  \node at(1, 66.5)[anchor = north, font = \bfseries, scale = 2]{ii};


  \node at (0, 55) [anchor = north west] {
  \includegraphics{../figures_melnikov/pfl3_6_poincare_hhf.png}
  };
  \node at (0, 44) [anchor = north west] {
  \includegraphics{../figures_melnikov/pfl3_6_poincare_traj_hhf.png}
  };

  \node at(0, 56)[anchor = north, font = \bfseries, scale = 3]{C};
  \node at(1, 55.5)[anchor = north, font = \bfseries, scale = 2]{i};
  \node at(1, 44.5)[anchor = north, font = \bfseries, scale = 2]{ii};
